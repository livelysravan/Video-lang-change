...
# Input video file
input_video_file = r"C:Users/sravansnair/Downloads/sravann.mp4"

# Output audio file
output_audio_file = "extracted_audio.mp3"

# Use FFmpeg to extract audio from the video
ffmpeg_extract_subclip(input_video_file, output_audio_file)
...
video = VideoFileClip(r"C:Users/sravansnair/Downloads/sravann.mp4")  # Replace with your original video file

# Load the translated audio
audio = AudioFileClip(r"C:\Users\sravansnair\Downloads\audio (2).wav")  # Replace with your translated audio file
